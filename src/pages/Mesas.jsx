...
export default Mesas;
    ...
    const loadTodayReservations = useCallback(async () => {
        ...
        try {
            ...
            // TODO: Considerar mover estas métricas al AuthContext
        } catch (error) {
    ...
    // TODO: Implementar cuando existan las tablas necesarias
    const loadAgentPreferences = useCallback(async () => {
        if (!restaurantId) return;

        try {
            // Simular preferencias del agente por ahora
            // TODO: Implementar RPC real cuando exista agent_table_preferences
...
const TableStatsModal = ({ isOpen, onClose, table, restaurantId }) => {
    ...
    const loadTableStats = async () => {
        setLoading(true);
        try {
            // TODO: Implementar RPC real cuando exista get_table_statistics
