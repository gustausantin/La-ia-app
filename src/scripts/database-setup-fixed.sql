-- =================================================
-- 🗄️ SETUP COMPLETO DE BASE DE DATOS SUPABASE - VERSIÓN CORREGIDA
...
-- Índices para analytics_historical (corregido)
CREATE INDEX IF NOT EXISTS idx_analytics_restaurant_type_date 
ON public.analytics_historical(restaurant_id, type, date);

CREATE INDEX IF NOT EXISTS idx_analytics_date_hour 
ON public.analytics_historical(date, hour);
