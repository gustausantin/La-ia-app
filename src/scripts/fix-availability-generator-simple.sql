-- ========================================
-- GENERADOR DE DISPONIBILIDADES SIMPLIFICADO
-- Fecha: 30 Septiembre 2025
-- Descripción: Versión simplificada SIN TURNOS - Solo horarios generales
-- ========================================

-- NOTA: Este script actualiza la función para usar SOLO operating_hours
-- Ya no consulta restaurant_schedule (turnos eliminados)
...
-- Ejemplo de uso:
-- SELECT generate_availability_slots_simple('restaurant-uuid'::UUID, '2025-09-30'::DATE, '2025-10-30'::DATE);
